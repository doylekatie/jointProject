...
<body>
    <div class="page-header">
        <h1>Hi, <b><?php echo htmlspecialchars($_SESSION["name"]); ?></b>. Welcome to the Coronavirus Test Booking Portal.</h1>
    </div>
    <p>
...
<!--The 'HSE' updates the details table with available appointments. This code will pull that info--> 
<!--from the table and print to user-->

<?php

// Prepare a select statement
        $query = mysqli_query($link, "select * from details");
...
<body>
     <p> 
        <a href="confirmed.php" class="btn btn-success">Book this Appointment</a>
    </p>
</body>
</html>