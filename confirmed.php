...
<body>
    <div class="page-header">
        <h1><b><?php echo htmlspecialchars($_SESSION["name"]) . ","; ?></b> your appointment has been confirmed.</h1>
    </div>
    <p>
...
$query = mysqli_query($link, "UPDATE bookingApp SET `Appointment Date` = '$Date2', `Appointment Time` = '$Time2' WHERE `username`= '$username'");
$query1 = mysqli_query($link, "UPDATE details SET `Status` = 'Confirmed'");
